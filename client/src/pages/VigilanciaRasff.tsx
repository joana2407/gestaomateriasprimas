...
export default function VigilanciaRasff() {
  ...
  const [sugestoesIa, setSugestoesIa] = useState<Record<string, { prioridade: PrioridadeAlerta; fundamento: string }>>({});
  ...
  const pedirSugestaoIa = async (item: ManualResultado) => {
    ...
    try {
      ...
      setSugestoesIa(anterior => ({ ...anterior, [key]: { prioridade: sugestao.prioridade as PrioridadeAlerta, fundamento: sugestao.fundamento } }));
