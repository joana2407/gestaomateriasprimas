...
export default function VigilanciaRasff() {
  ...
  const filteredResults = useMemo(() => {
    ...
    const resultados = resultadosComPrioridade.filter(item => {
      ...
      return matchesPriority && matchesDate && matchesAlertNumber && matchesMp;
    });
  ...
  }, [manualFile, resultadosComPrioridade, priorityFilter, alertNumberFilter, mpFilter, dateFrom, dateTo]);
