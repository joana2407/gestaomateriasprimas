...
export default function Rececoes() {
  ...
  const controlosGranelNaoAplicaveis = form.controlos.numeroSelo === "N/A" && form.controlos.numeroSilo === "N/A" && form.controlos.crivo === "na" && form.controlos.fechoBocaCarga === "na";
  function definirTipoFornecimento(tipo: "saco" | "granel") {
    setForm(current => ({
      ...current,
      controlos: tipo === "saco" ? marcarControlosGranelNaoAplicaveis(current.controlos) : prepararControlosGranel(current.controlos),
    }));
  }
