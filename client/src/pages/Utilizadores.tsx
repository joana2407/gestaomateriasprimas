...
type Perfil = "logistica" | "qualidade";
const emptyNovo = { nome: "", role: "logistica" as Perfil, pin: "", confirmarPin: "" };

function etiquetaPerfil(perfil: Perfil) { return perfil === "qualidade" ? "Qualidade" : "Logística"; }
